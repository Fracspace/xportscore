...
export const declarationSchema = z.object({
  ...
  documentAuthenticity: z.boolean().refine((val) => val === true, {
    message: "You must accept the Document Authenticity declaration."
  }),

  privateAuditAcknowledgement: z.boolean().refine((val) => val === true, {
    message: "You must accept the Private Audit Acknowledgement."
  }),

  noGuaranteeAcknowledgement: z.boolean().refine((val) => val === true, {
    message: "You must accept the No Guarantee Acknowledgement."
  }),

  revocationAcknowledgement: z.boolean().refine((val) => val === true, {
