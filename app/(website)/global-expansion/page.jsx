    ...
    <main className="bg-surface text-on-surface">
      ...
      <section className="relative pt-32 pb-24 px-margin-desktop overflow-hidden">
        <div className="max-w-container-max mx-auto text-center relative z-10">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-10">
            ...
            <strong>Investment: ₹20 Lakhs</strong>
          </p>
      ...
      <section className="py-24 px-margin-desktop bg-primary-container text-on-primary">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-headline-lg text-headline-lg mb-8">₹20 Lakhs Isn't the Cost of a Report. <br /><span className="text-secondary-fixed">It's the Cost of an Execution Team.</span></h2>
